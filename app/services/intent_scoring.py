...
BUY_INTENT_KEYWORDS = [
    ...
    "запрос",
    # Строго первое лицо. Основа "планиру" ловила "планируйте свой отдых" из
    # рекламы экскурсий: это повелительное наклонение продавца, а не размышление
    # покупателя. На живом прогоне так прошли два ложных сигнала из трёх.
    "присматрива", "рассматрива", "планирую", "планируем",
